...
INSERT INTO appointments (type, state, doctor_id, specialty_id, patient_id, appointment_date, appointment_time, work_period_id)
VALUES
-- =============== DOCTOR 3 - Otorri (20min) ===============
('SCHEDULED', 'ACCEPTED', 3, 1, 7, '2025-11-03', '08:00:00', 1),
('SCHEDULED', 'ACCEPTED', 3, 1, 8, '2025-11-03', '08:20:00', 1),
('WALK_IN',   'ACCEPTED', 3, 1, 9, '2025-11-03', '08:40:00', 1),
('WALK_IN',   'ACCEPTED', 3, 1,10, '2025-11-03', '09:00:00', 1),

('SCHEDULED', 'ACCEPTED', 4, 2, 7, '2025-11-03', '09:00:00', 1);
--('SCHEDULED', 'ACCEPTED', 3, 1, 8, '2025-11-03', '08:20:00', 1),
--('WALK_IN',   'ACCEPTED', 3, 1, 9, '2025-11-03', '08:40:00', 1),
--('WALK_IN',   'ACCEPTED', 3, 1,10, '2025-11-03', '09:00:00', 1),

--('SCHEDULED', 'ACCEPTED', 3, 1,11, '2025-11-05', '12:00:00', 2),
--('SCHEDULED', 'ACCEPTED', 3, 1,12, '2025-11-05', '12:20:00', 2),
--('WALK_IN',   'ACCEPTED', 3, 1,13, '2025-11-07', '16:00:00', 3),
--('WALK_IN',   'ACCEPTED', 3, 1,14, '2025-11-07', '16:20:00', 3),

-- =============== DOCTOR 4 - Pediatra (30min) ===============
--('SCHEDULED', 'ACCEPTED', 4, 2, 9, '2025-11-03', '08:00:00', 1),
--('SCHEDULED', 'ACCEPTED', 4, 2,10, '2025-11-03', '08:30:00', 1),
--('WALK_IN',   'ACCEPTED', 4, 2,11, '2025-11-03', '12:00:00', 2),
--('WALK_IN',   'ACCEPTED', 4, 2,12, '2025-11-03', '12:30:00', 2),

--('SCHEDULED', 'ACCEPTED', 4, 2,13, '2025-11-04', '16:00:00', 3),
--('SCHEDULED', 'ACCEPTED', 4, 2,14, '2025-11-04', '16:30:00', 3),
--('WALK_IN',   'ACCEPTED', 4, 2,15, '2025-11-06', '08:00:00', 1),
--('WALK_IN',   'ACCEPTED', 4, 2,16, '2025-11-06', '08:30:00', 1),

-- =============== DOCTOR 4 - Generalista (35min) ===============
--('SCHEDULED', 'ACCEPTED', 4, 3, 7, '2025-11-05', '08:00:00', 1),
--('SCHEDULED', 'ACCEPTED', 4, 3, 8, '2025-11-05', '08:35:00', 1),
--('WALK_IN',   'ACCEPTED', 4, 3, 9, '2025-11-05', '12:00:00', 2),
--('WALK_IN',   'ACCEPTED', 4, 3,10, '2025-11-05', '12:35:00', 2),

--('SCHEDULED', 'ACCEPTED', 4, 3,11, '2025-11-07', '12:00:00', 2),
--('SCHEDULED', 'ACCEPTED', 4, 3,12, '2025-11-07', '12:35:00', 2),
--('WALK_IN',   'ACCEPTED', 4, 3,13, '2025-11-07', '16:00:00', 3),
--('WALK_IN',   'ACCEPTED', 4, 3,14, '2025-11-07', '16:35:00', 3),

-- =============== DOCTOR 5 - Otorri (20min) ===============
--('SCHEDULED', 'ACCEPTED', 5, 1, 9, '2025-11-04', '08:00:00', 1),
--('SCHEDULED', 'ACCEPTED', 5, 1,10, '2025-11-04', '08:20:00', 1),
--('WALK_IN',   'ACCEPTED', 5, 1,11, '2025-11-04', '08:40:00', 1),
--('WALK_IN',   'ACCEPTED', 5, 1,12, '2025-11-04', '09:00:00', 1),

--('SCHEDULED', 'ACCEPTED', 5, 1,13, '2025-11-04', '12:00:00', 2),
--('SCHEDULED', 'ACCEPTED', 5, 1,14, '2025-11-04', '12:20:00', 2),
--('WALK_IN',   'ACCEPTED', 5, 1,15, '2025-11-06', '16:00:00', 3),
--('WALK_IN',   'ACCEPTED', 5, 1,16, '2025-11-06', '16:20:00', 3);
